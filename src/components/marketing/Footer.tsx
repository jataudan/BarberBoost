            ...
            <div className="flex gap-2">
              {SOCIALS.map(({ label, href, icon }) => (
                <a
                  ...
                  className="w-8 h-8 rounded-lg bg-[#161616] border border-[#222] flex items-center justify-center text-zinc-500 hover:text-[#c9a84c] hover:border-[#c9a84c]/40 transition-colors"
                >
                  {icon}
                </a>
              ))}
